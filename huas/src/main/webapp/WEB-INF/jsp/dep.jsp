	 ...
	 $("#add").click(function(){
		...
		if(!value){
		 alert("不能为空");	
			 ...
			 window.location="${ctx }/user/admin/index/dep/add?depName="+value;
		}
	 ...
	 $("#createBtn").click(function(){
		...
		if(!creDepName){
		 alert("不能为空");	
			 ...
			 window.location="${ctx }/user/admin/index/dep/update?depName="+creDepName+"&depId="+creDepId;
		}
...
<div class="panel panel-default " >
					...
					<div class="panel-body" style="margin-bottom: 100px;">
						...
						<div class="row">
							<div class=" col-md-3">
								...
								<span style="font-size: 25px;">院系管理</span>
 ...
 <c:forEach items="${list}" var="ItemList">
							<tr style='cursor: pointer'>
								<td>${ItemList.depId }</td>
								<td>${ItemList.depName }</td>
						
						       
								<td><a
									href="${ctx }/user/admin/index/dep/delete?id=${ItemList.depId }"
									style="color: #3399EA; font-size: 13px;" onclick="return confirm('确定要删除 该用户吗  ？')">删除</a>
									<a style="color: #3399EA; font-size: 13px;"
									href="${ctx }/user/admin/index/major?depId=${ItemList.depId }">专业</a></td>
							</tr>
						</c:forEach>
